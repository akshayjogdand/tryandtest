...
def selected_players_are_unique(ms, var_string):
    ...
    return len(set(player_selection.values())) == len(player_selection)


def error_message_function(member_submission):
    return "Please select different players for Top Batsmen fields."


calculation = lambda: selected_players_are_unique(member_submission, "batsman")
