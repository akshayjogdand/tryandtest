...
def strike_rate_points(strike_rate, balls, was_out, batting_position):
    ...
    if base_points <= 90 and batting_position >= 9 and batting_position <= 11:
        return -10

    if base_points <= 40.0:
        return -40
    if base_points > 40.0 and base_points <= 60.0:
        return -30
    if base_points > 60.0 and base_points <= 75.0:
        return -20
    if base_points > 75.0 and base_points <= 90.0:
        return -10
    if base_points > 90.0 and base_points <= 105.0:
        return 0
    if base_points > 105.0 and base_points <= 125.0:
        return 10
    if base_points > 125.0 and base_points <= 150.0:
        return 20
    if base_points > 150.0 and base_points <= 180.0:
        return 30
    if base_points > 180.0:
        return 40
