...
# Evin
batsman_two = Player.objects.get(id=367)

# Shreyas
batsman_three = Player.objects.get(id=395)

# Bowlers
# Shami
bowler_one = Player.objects.get(id=37)

# Kumar
bowler_two = Player.objects.get(id=154)

# Khalil
bowler_three = Player.objects.get(id=24)
...
# Kumar
mvp_two = Player.objects.get(id=154)

# Evin
mvp_three = Player.objects.get(id=367)
...
m.tournament = t
m.match_number = 4
m.name = 'Wind. vs Ind. ODI, Final Scores: pre-Tournament Predictions + Match Predictions'
m.short_display_name = 'Wind. vs Ind. ODI, Final Scores'
m.fake_match = True
