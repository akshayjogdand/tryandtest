...
# Batsmen
# Vihari
batsman_one = Player.objects.get(id=486)

# Rahane
batsman_two = Player.objects.get(id=139)

# Kohli
batsman_three = Player.objects.get(id=106)

# Bowlers
# Bumrah
bowler_one = Player.objects.get(id=368)

# Ishant Sharma
bowler_two = Player.objects.get(id=140)

# Kemar
bowler_three = Player.objects.get(id=428)

# Most Valuable Players
# Bumrah
mvp_one = Player.objects.get(id=368)

# Krunal Pandya
mvp_two = Player.objects.get(id=140)

# Holder
mvp_three = Player.objects.get(id=52)
...
def margin(prediction):
    ...
    if (
        ...
        and prediction.win_series_margin == 2
    ):
        tps = TouramentPredictionScore()
        tps.prediction = prediction
...
m.tournament = t
m.match_number = 4
m.name = 'Wind. vs Ind. Tests, Final Scores: pre-Tournament Predictions + Match Predictions'
m.short_display_name = 'Wind. vs Ind. Tests, Final Scores'
m.fake_match = True
