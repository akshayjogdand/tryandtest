...
# Teams
# England
team_one = Team.objects.get(id=14)

# Batsmen
# D Malan
batsman_one = Player.objects.get(id=545)

# Eoin Morgan
batsman_two = Player.objects.get(id=156)

# Bowlers
# Mitchell Santner
bowler_one = (Player.objects.get(id=299),)

# Chris Jordan
bowler_two = (Player.objects.get(id=205),)

# Most Valuable Players
# Malan
mvp_one = Player.objects.get(id=545)

# Santner
mvp_two = Player.objects.get(id=299)
...
def run(fake_match_id, *args):
    ...
    tournament = Tournament.objects.get(id=10)
...
"""
import datetime
t = Tournament.objects.get(id=10)
v = Venue.objects.get(id=41)
m = Match()
md = '11/11/2019'

m.tournament = t
m.match_number = 6
m.name = 'ENG vs. NZ 2019 T-20, Final Scores: pre-Tournament Predictions + Match Predictions'
m.short_display_name = 'ENG vs. NZ 2019 T-20, Final Scores'
m.fake_match = True
