...
# Batsmen
# Warner
batsman_one = Player.objects.get(id=165)

# Finch
batsman_two = Player.objects.get(id=1)
...
# Zampa
bowler_two = (Player.objects.get(id=144),)

# Most Valuable Players
# Warner
mvp_one = Player.objects.get(id=165)

# Cummins
mvp_two = Player.objects.get(id=208)
...
"""
import datetime
t = Tournament.objects.get(id=9)
v = Venue.objects.get(id=36)
m = Match()
md = '02/11/2019'

m.tournament = t
m.match_number = 4
m.name = 'Aus vs. SL 2019 T-20, Final Scores: pre-Tournament Predictions + Match Predictions'
m.short_display_name = 'Aus vs. SL 2019 T-20, Final Scores'
m.fake_match = True
