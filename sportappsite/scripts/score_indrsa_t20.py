...
# SA
team_two = Team.objects.get(id=16)
...
# Quinton de Kock
batsman_two = Player.objects.get(id=28)

# Bowlers
# Rabada
bowler_one = Player.objects.get(id=210)

# Bjorn Fortuin
bowler_two = Player.objects.get(id=518)
...
# Quinton de Kock
mvp_two = Player.objects.get(id=28)
...
"""
import datetime
t = Tournament.objects.get(id=8)
v = Venue.objects.get(id=27)
m = Match()

m.tournament = t
m.match_number = 4
m.name = 'India vs. South Africa T20 Final Scores: pre-Tournament Predictions + Match Predictions'
m.short_display_name = 'India vs. South Africa T-20 Final Scores'
m.fake_match = True
